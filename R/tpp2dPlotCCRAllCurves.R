#' @title Plot all 2D-TPP CCR curves 
#' @description Generates a list of plots for all proteins with all curves for the different 
#' temperatures of for a certain 2D-TPP experiment.
#'  
#' @return A list of all dose-reponse plots that could be fitted  
#' @examples
