...
# #   testData <- tpp2dImportData(configTable=configTable, data=data, idVar="representative", 
...
#   configTable <- panobinostat_2DTPP_config
#   data <- NULL
#   expect_error(tpp2dImportData(configTable=configTable, data=data, idVar="representative", 
#                                intensityStr="sumionarea_protein_", 
#                                addCol=c("qusm","clustername", "msexperiment_id"), 
#                                qualColName="qupm", fcStr=NULL))
# })
