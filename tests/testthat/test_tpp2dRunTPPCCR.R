...
test_that("evalRunCCR", code={
  CCRresults <- tpp2dRunTPPCCR(configFile=exampleCCRConfig, data=exampleRunCCRInput, idVar="unique_ID")
...
test_that("evalRunCCRErr1", code={
  expect_error(tpp2dRunTPPCCR(configFile=exampleCCRConfig, data=exampleRunCCRInput, idVar="noneSense"))
})

test_that("evalRunCCRErr2", code={
  expect_error(tpp2dRunTPPCCR(configFile=exampleCCRConfig, data=exampleRunCCRInput, idVar="representative"))
})

test_that("evalRunCCRErr3", code={
  expect_error(tpp2dRunTPPCCR(data=exampleRunCCRInput, idVar="representative"))
})
